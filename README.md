...
O projeto consta em uma tela de login para o APP da FIAP, denominado de FIAPP.

Nele, caso o aluno já tenha uma conta no aplicativo, ele vai poder inserir seu respectivo e-mail e senha nos campos determinados a isso.
...
Projeto desenvolvido com React Native utilizando os componentes base:
- Texto
- Input
- Botão
- Imagem
...
Estilização realizada com StyleSheet
